...
if(form && form.dataset.demo==='true')form.addEventListener('submit',e=>{e.preventDefault();document.querySelector('.toast')?.classList.add('show');setTimeout(()=>document.querySelector('.toast')?.classList.remove('show'),3500);form.reset()});
